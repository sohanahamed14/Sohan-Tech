...
const PRODUCTS = {
  ...
  drones: [
    { id: 'd1', brand: 'DJI', name: 'Mavic 3 Pro', desc: 'Triple-Camera System · 4/3 CMOS Hasselblad Camera · 43-Min Flight Time · 15km O3+ HD Video', price: 249999, old: 269999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#1f1c2c,#928dab)', rating: 4.9, reviews: 1240 },
    { id: 'd2', brand: 'DJI', name: 'Air 3S', desc: 'Dual 1" CMOS Primary Camera · 48MP HDR · 45-Min Flight · Omnidirectional Obstacle Sensing', price: 134999, old: 149999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#3a6186,#89253e)', rating: 4.8, reviews: 920 },
    { id: 'd3', brand: 'DJI', name: 'Avata 2', desc: 'FPV Drone · 1/1.3" CMOS Super-Wide 4K/60fps · 23-Min Flight · ACRO Tricks & Motion Controller', price: 119999, old: null, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#2C3E50,#FD746C)', rating: 4.8, reviews: 645 },
    { id: 'd4', brand: 'DJI', name: 'Mini 4 Pro', desc: 'Under 249g Ultra-Light · Omnidirectional Sensing · 4K/60fps HDR True Vertical Shooting', price: 99999, old: null, badge: 'New', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#FFAF7B,#D76D77)', rating: 4.8, reviews: 890 },
    { id: 'd5', brand: 'Autel', name: 'EVO Nano+', desc: '249g · 1/1.28" CMOS 50MP RYYB Color Array · PDAF+CDAF Autofocus · 28-Min Flight', price: 84999, old: 94999, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#eb3349,#f45c43)', rating: 4.7, reviews: 512 },
    { id: 'd6', brand: 'DJI', name: 'Inspire 3', desc: 'Full-Frame 8K Cinema Drone · ProRes RAW / CinemaDNG · RTK Centimeter-level Positioning', price: 999999, old: 1050000, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#000000,#434343)', rating: 5.0, reviews: 180 },
    { id: 'd7', brand: 'Autel', name: 'EVO Lite+', desc: '6K 30fps Video · 1" CMOS Sensor · 40-Min Flight · Dynamic Track 2.1 · 12km Transmission', price: 149999, old: 164999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#f857a6,#ff5858)', rating: 4.7, reviews: 340 },
    { id: 'd8', brand: 'Autel', name: 'EVO II Pro V3', desc: '6K 1" Sony Sensor · 12-bit A-Log · 360° Obstacle Avoidance · 42-Min Flight', price: 219999, old: 239999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#4e54c8,#8f94fb)', rating: 4.8, reviews: 420 },
    { id: 'd9', brand: 'Skydio', name: 'Skydio 2+ Cinema Kit', desc: 'Autonomous 360° AI Tracking & Follow-Me · 4K60 HDR · KeyFrame Flight Paths', price: 189999, old: null, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#0f2027,#203a43)', rating: 4.8, reviews: 290 },
    { id: 'd10', brand: 'DJI', name: 'Mini 3 Fly More Combo', desc: 'Under 249g · 4K HDR · 38-Min Battery · True Vertical Shooting · Level 5 Wind Resistance', price: 69999, old: 79999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#11998e,#38ef7d)', rating: 4.7, reviews: 1450 },
    { id: 'd11', brand: 'DJI', name: 'Neo Compact Drone', desc: '135g Palm Takeoff & Landing · AI Subject Tracking · 4K Ultra-Stabilized Video', price: 27999, old: 32999, badge: 'New', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#fc4a1a,#f7b733)', rating: 4.6, reviews: 830 },
    { id: 'd12', brand: 'Holy Stone', name: 'HS720G 2-Axis Gimbal', desc: '4K EIS Camera · 2-Axis Gimbal · Brushless Motor · GPS Auto Return · 26-Min Flight', price: 39999, old: 45999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#2980b9,#2c3e50)', rating: 4.4, reviews: 920 },
    { id: 'd13', brand: 'Holy Stone', name: 'HS175D 4K GPS Drone', desc: '4K Ultra HD Camera · GPS Assisted Flight · Optical Flow Positioning · 46-Min (2 Batteries)', price: 24999, old: 29999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#373b44,#4286f4)', rating: 4.3, reviews: 1120 },
    { id: 'd14', brand: 'Holy Stone', name: 'HS440 Foldable FPV', desc: '1080P HD Auto-Adjustable Camera · 20-Min Flight · Gravity Sensor · Voice Control', price: 14999, old: 17999, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#8e2de2,#4a00e0)', rating: 4.3, reviews: 750 },
    { id: 'd15', brand: 'BetaFPV', name: 'Cetus Pro FPV Kit', desc: 'Ready to Fly FPV Drone · Includes VR02 FPV Goggles + LiteRadio 2 SE Transmitter', price: 34999, old: 39999, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#ff416c,#ff4b2b)', rating: 4.7, reviews: 580 },
    { id: 'd16', brand: 'BetaFPV', name: 'Pavo20 Whoop Quadcopter', desc: 'HD Digital VTX Support · Pocket-Sized Cinematic Cinewhoop · Carbon Fiber Frame', price: 21999, old: null, badge: 'New', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#134e5e,#71b280)', rating: 4.6, reviews: 310 },
    { id: 'd17', brand: 'DJI', name: 'Mavic 3 Classic', desc: '4/3 CMOS Hasselblad 5.1K HD · 46-Min Flight Time · Omnidirectional Obstacle Sensing', price: 169999, old: 184999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#005aa7,#fffde4)', rating: 4.9, reviews: 840 },
    { id: 'd18', brand: 'DJI', name: 'Matrice 350 RTK', desc: 'Commercial Enterprise Grade · 55-Min Flight · IP55 Weatherproof · 2.7kg Payload Support', price: 849999, old: null, badge: 'Hot', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#141e30,#243b55)', rating: 5.0, reviews: 95 },
    { id: 'd19', brand: 'Autel', name: 'EVO Max 4T', desc: 'Triple Optical + Thermal + Night Vision Zoom · Autonomous Obstacle Avoidance · A-Mesh 1.0', price: 699999, old: null, badge: 'New', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#e65c00,#F9D423)', rating: 4.9, reviews: 110 },
    { id: 'd20', brand: 'DJI', name: 'FPV Combo 4K', desc: '140km/h High-Speed Racing Drone · 150° Super-Wide FOV 4K/60fps · Emergency Brake & Hover', price: 109999, old: 124999, badge: 'Sale', emoji: '🚁', img: 'images/drones/drone.png', bg: 'linear-gradient(135deg,#cc2b5e,#753a88)', rating: 4.7, reviews: 740 },
  ]
};
...
const LIVE_PURCHASES = [
  ...
  { name: 'DJI Mini 4 Pro 4K HDR', img: 'images/drones/drone.png', city: 'Cox\'s Bazar', time: '55 mins ago', id: 'd4', price: 99999 }
];
